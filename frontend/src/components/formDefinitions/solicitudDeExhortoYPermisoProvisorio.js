export const title = "Solicitud de exhorto y permiso provisorio para conducir";
...
export const fields = [
    ...
    },
    {
        ...
        label: 'FOMULARIO DE EXHORTO',
        type: 'download-link',
        href: '/JuzgadoDePoliciaLocal/Exhorto SOLICITUD notificacion electrónico PERMISO PROVISORIO.pdf',
