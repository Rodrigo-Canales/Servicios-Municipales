export const title = "Solicitud para lista de testigos";
...
export const fields = [
    ...
    },
    {
        ...
        label: 'Formulario de Reposición o Reconsideración',
        type: 'download-link',
        href: '/JuzgadoDePoliciaLocal/Causas LISTA DE TESTIGOS PMG.pdf',
